...
const printNextSteps = (alreadyRegistered: boolean): void => {
  ...
  console.log('')
  console.log(
    '     The Foldkit Vite plugin publishes its DevTools relay for this server to find.',
  )
  console.log(
    '     Set devToolsMcpPort in vite.config.ts only for a fixed port, and then set',
  )
  console.log(
    '     FOLDKIT_DEVTOOLS_MCP_PORT to the same value for this server.',
  )
  console.log('')
  console.log(
