 ...
 *  handlers that dispatch the parent's `onToggle` Message. */
export type DisclosureAttributes<ParentMessage> = Readonly<{
  button: ReadonlyArray<Attribute<ParentMessage>>
  panel: ReadonlyArray<Attribute<ParentMessage>>
...
export type ViewConfig<ParentMessage> = Readonly<{
  id: string
  isOpen: boolean
  onToggle: (isOpen: boolean) => ParentMessage
  toView: (attributes: DisclosureAttributes<ParentMessage>) => Html
  isDisabled?: boolean
  ariaLabel?: string
