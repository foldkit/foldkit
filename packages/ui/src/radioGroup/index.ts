...
/** Union of OutMessages the radio group can produce. Surfaced through the
 *  optional `outMessage` field of `update`'s return and pattern-matched by
 *  the parent. */
 ...
 *  const planRadioGroupUpdate = PlanRadioGroup.update(model, message)
 *  ```
 *
