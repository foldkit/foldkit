...
- [#683](https://github.com/foldkit/foldkit/pull/683) [`b58e602`](https://github.com/foldkit/foldkit/commit/b58e60279bccc6584985315645bfae664a7b90c5) Thanks [@devinjameson](https://github.com/devinjameson)! - The Commands tab now shows when a Command's destination is unresolved and displays its exact Submodel path once the result Message arrives. The Foldkit peer minimum is now 0.161.0 because earlier runtimes do not provide this field.
