  ...
  M.value(route).pipe(
    ...
    M.tagsExhaustive({
      ...
      PatternsSubscriptionOrganization: () =>
        patternsSubscriptionOrganizationRouter(),
      PatternsModelAsCache: () => patternsModelAsCacheRouter(),
      PatternsComposingUpdateSteps: () => patternsComposingUpdateStepsRouter(),
      PatternsRouteDrivenLoading: () => patternsRouteDrivenLoadingRouter(),
      PatternsRevalidatingCaches: () => patternsRevalidatingCachesRouter(),
