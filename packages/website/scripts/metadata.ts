...
const METADATA_BY_TAG: Record<StaticRouteTag, PageMetadata> = {
  ...
  CoreLifecycleHooks: core(
    'Lifecycle Hooks',
    'Mount-time and unmount-time DOM hooks for integrating third-party libraries. OnInsert, OnInsertEffect, and OnDestroy keep imperative work confined to the seam where the virtual DOM meets the real one.',
  ),
