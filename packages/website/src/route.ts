...
export const PatternsRoutingSubmodelsRoute = r('PatternsRoutingSubmodels')
...
export const patternsRoutingSubmodelsRouter = pipe(
  literal('patterns'),
  slash(literal('routing-submodels')),
  mapTo(PatternsRoutingSubmodelsRoute),
)
