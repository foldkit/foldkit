...
// The returned function takes the child's own Model + Message and produces
// Html. The parent will lift these Messages into its wrapper Message when
// it embeds the Submodel.
