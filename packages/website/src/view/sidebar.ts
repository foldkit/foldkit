...
const computeNavLinks = (
  idPrefix: string,
  route: Model['route'],
  getStartedGroup: boolean,
  coreConceptsGroup: boolean,
  comparisonsGroup: boolean,
  faqGroup: boolean,
  testingGroup: boolean,
  bestPracticesGroup: boolean,
  patternsGroup: boolean,
  toolingGroup: boolean,
  examplesGroup: boolean,
  foldkitUiGroup: boolean,
  aiGroup: boolean,
  apiReferenceGroup: boolean,
): Html => {
  const h = html<Message>()
  ...
  const openByKey: Record<GroupKey, boolean> = {
    getStarted: getStartedGroup,
    coreConcepts: coreConceptsGroup,
    comparisons: comparisonsGroup,
    faq: faqGroup,
    testing: testingGroup,
    bestPractices: bestPracticesGroup,
    patterns: patternsGroup,
    tooling: toolingGroup,
    examples: examplesGroup,
    foldkitUi: foldkitUiGroup,
    ai: aiGroup,
    apiReference: apiReferenceGroup,
  }
