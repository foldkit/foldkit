...
const ruleGroups: ReadonlyArray<RuleGroup> = [
  {
    ...
    rules: [
      {
        heading: ruleHeading('require-past-tense-message-names'),
        description:
          'Requires verb-first, past-tense Message names, so Messages read as facts that happened rather than imperative commands. Accepts any -ed verb plus common irregulars, and takes an extraVerbs option per app.',
        raw: Snippet.lintRequirePastTenseMessageNamesRaw,
        highlighted: Snippet.lintRequirePastTenseMessageNamesHighlighted,
      },
      {
        heading: ruleHeading('no-changed-message-prefix'),
        description:
          'Rejects the vague Changed prefix. A more precise verb almost always fits: Updated for an edited value, Selected for a discrete choice, Toggled for a flip.',
        raw: Snippet.lintNoChangedMessagePrefixRaw,
        highlighted: Snippet.lintNoChangedMessagePrefixHighlighted,
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        heading: ruleHeading('no-explicit-command-type-annotation'),
        description:
          'Drops the explicit Command type annotation. Command.define already carries the type, so the annotation is redundant.',
        raw: Snippet.lintNoExplicitCommandTypeAnnotationRaw,
        highlighted: Snippet.lintNoExplicitCommandTypeAnnotationHighlighted,
      },
      {
        heading: ruleHeading('require-succeeded-failed-pair'),
        description:
          'Flags a Succeeded* result with no Failed* twin. Naming a result Succeeded implies failure is meaningful, so pair it or pick a plainer past-tense verb.',
        raw: Snippet.lintRequireSucceededFailedPairRaw,
        highlighted: Snippet.lintRequireSucceededFailedPairHighlighted,
      },
      {
        heading: ruleHeading('require-completed-mirrors-command'),
        description:
          'Requires a Completed* acknowledgement to mirror its Command name: LockScroll produces CompletedLockScroll.',
        raw: Snippet.lintRequireCompletedMirrorsCommandRaw,
        highlighted: Snippet.lintRequireCompletedMirrorsCommandHighlighted,
      },
    ],
  },
  {
    ...
    rules: [
      {
        heading: ruleHeading('prefer-evo-over-model-spread'),
        description:
          'Prefers evo over spreading the Model in update code. evo keeps the strict-keys guarantee a spread drops.',
        raw: Snippet.lintPreferEvoOverModelSpreadRaw,
        highlighted: Snippet.lintPreferEvoOverModelSpreadHighlighted,
      },
      {
  ...
  },
  {
    ...
    rules: [
      {
        heading: ruleHeading('route-union-parser-registration'),
        description:
          'Keeps the route union, its Route.mapTo Routers, and the Route.oneOf registration in sync. Flags union members no Router parses and Routers that are never registered.',
        raw: Snippet.lintRouteUnionParserRegistrationRaw,
        highlighted: Snippet.lintRouteUnionParserRegistrationHighlighted,
      },
      {
        heading: ruleHeading('route-oneof-shadowing-order'),
        description:
          'Flags a Router in Route.oneOf that can never match because an earlier Router accepts the same path shape. Order Routers most specific first.',
        raw: Snippet.lintRouteOneofShadowingOrderRaw,
        highlighted: Snippet.lintRouteOneofShadowingOrderHighlighted,
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        heading: ruleHeading('label-requires-for'),
        description:
          'Requires a label to associate with a control through For, or to nest the control, for accessible forms.',
        raw: Snippet.lintLabelRequiresForRaw,
        highlighted: Snippet.lintLabelRequiresForHighlighted,
      },
      {
  ...
  },
  {
    ...
    rules: [
      ...
      {
        heading: ruleHeading('no-impure-calls-in-pure-layer'),
        description:
          'Keeps clock reads, randomness, and browser globals out of init, Model, update, and view files. Side effects belong in Command, Mount, or Subscription factories.',
        raw: Snippet.lintNoImpureCallsInPureLayerRaw,
        highlighted: Snippet.lintNoImpureCallsInPureLayerHighlighted,
      },
      {
  ...
  },
  {
    ...
    rules: [
      {
        heading: ruleHeading('managed-resource-for-stateful-handles'),
        description:
          'Requires stateful browser handles like WebSocket to be scoped to a ManagedResource rather than created loose.',
        raw: Snippet.lintManagedResourceForStatefulHandlesRaw,
        highlighted: Snippet.lintManagedResourceForStatefulHandlesHighlighted,
      },
      {
  ...
  },
  {
    ...
    rules: [
      {
        heading: ruleHeading('prefer-dom-helpers-for-element-ops'),
        description:
          'Prefers Foldkit DOM helpers over raw element methods, which throw on a missing node and sit outside the Effect flow.',
        raw: Snippet.lintPreferDomHelpersForElementOpsRaw,
        highlighted: Snippet.lintPreferDomHelpersForElementOpsHighlighted,
      },
      {
        heading: ruleHeading('prefer-empty-over-empty-element'),
        description:
          'Prefers the empty node over an empty element used as a placeholder for nothing.',
        raw: Snippet.lintPreferEmptyOverEmptyElementRaw,
        highlighted: Snippet.lintPreferEmptyOverEmptyElementHighlighted,
      },
      {
        heading: ruleHeading('ui-toview-must-spread-attribute-bundles'),
        description:
          'Requires a @foldkit/ui toView callback to spread the attribute bundles it receives, so ARIA, handlers, and Submodel wiring are not dropped.',
        raw: Snippet.lintUiToviewMustSpreadAttributeBundlesRaw,
        highlighted: Snippet.lintUiToviewMustSpreadAttributeBundlesHighlighted,
      },
      {
  ...
  {
    heading: groupHeading('test-rules', 'Test Shape'),
    rules: [
      {
        heading: ruleHeading('subscription-file-canonical-shape'),
        description:
          'Requires a subscription file to export one canonical subscriptions const and to aggregate rather than spread subscription records, so duplicate keys fail loudly.',
        raw: Snippet.lintSubscriptionFileCanonicalShapeRaw,
        highlighted: Snippet.lintSubscriptionFileCanonicalShapeHighlighted,
      },
      {
        heading: ruleHeading('prefer-story-command-matchers'),
        description:
          'Prefers Story.Command matchers over hand-rolled command assertions in tests, which account for Foldkit command identity and unresolved-command coverage.',
        raw: Snippet.lintPreferStoryCommandMatchersRaw,
        highlighted: Snippet.lintPreferStoryCommandMatchersHighlighted,
      },
    ],
  },
]
