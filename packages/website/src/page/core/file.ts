  ...
  h.div(
    ...
    [
      ...
      para(
        ...
        ' OutMessage when files arrive (whether dropped or picked through the input). If the component does not fit a use case you have in mind, open an issue rather than hand-rolling against the underlying html attributes.',
      ),
      highlightedCodeBlock(
        h.div(
          [
      ...
      para(
        'Scene tests exercise file flows through three helpers. ',
