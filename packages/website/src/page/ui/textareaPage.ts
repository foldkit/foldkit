...
const viewConfigProps: ReadonlyArray<PropEntry> = [
  ...
  },
  {
    ...
    default: 'false',
    description:
      'Whether the textarea references a description element via aria-describedby. Set it to true only when you render the description element, so the reference never dangles.',
  },
  {
    name: 'name',
    type: 'string',
    ...
    return h.div(
      ...
      [
        ...
        para(
          ...
          ' on the textarea, and only when you actually render the description element so the reference never dangles. You can access the description ID directly with ',
