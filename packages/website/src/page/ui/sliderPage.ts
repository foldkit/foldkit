...
export const view = (
  ...
  div(
    ...
    [
      ...
      para(
        'A numeric range input for values that sit on a continuous or stepped scale. Common uses include pain scales, volume controls, filter thresholds, and brightness settings. Follows the WAI-ARIA slider pattern with ',
