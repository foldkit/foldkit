...
const viewConfigProps: ReadonlyArray<PropEntry> = [
  ...
  },
  {
    ...
    description:
      'Maps the new open state to a Message in your parent Message type when the user toggles the disclosure. Your update handler just stores the value.',
  },
  {
    name: 'toView',
    ...
    return h.div(
      ...
      [
        ...
        para(
          ...
          ', and ',
          inlineCode('onToggle'),
          ' dispatches a parent Message when the user toggles it. In your update handler, just store the value. Use it for FAQs, accordions, and collapsible sections. For overlaying content in a floating panel, use Dialog or Popover instead.',
        ),
        infoCallout(
          'See it in an app',
