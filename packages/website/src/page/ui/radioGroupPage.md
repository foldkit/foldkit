...
| Name       | Type                              | Default | Description                                                                                                                                                                                                                                                                                                      |
| ---------- | --------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Selected` | `{ value: Value; index: number }` | —       | Emitted when an option is committed via click or keyboard. Carries both the option's value (typed as your `Value` union via `RadioGroup.create<Value>()`) and its index. A read-only group never emits it. Pattern-match the bundle update's optional `outMessage` field in your `GotRadioGroupMessage` handler. |
