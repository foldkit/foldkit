...
export const view = (
  ...
  div(
    ...
    [
      ...
      para(
        'Sortable lists and cross-container movement with pointer tracking, keyboard navigation, collision detection, auto-scrolling, and screen reader announcements. DragAndDrop uses the OutMessage pattern — your update function receives ',
        inlineCode('Reordered'),
        ' and ',
        inlineCode('Cancelled'),
        ' events and decides how to reorder your data.',
      ),
      para(
        'Unlike other UI components, DragAndDrop doesn\u2019t use ',
        inlineCode('view()'),
        '. Instead, you spread ',
        inlineCode('draggable()'),
        ' and ',
        inlineCode('droppable()'),
        ' attributes onto your existing elements. You also need to forward ',
        inlineCode('DragAndDrop.subscriptions'),
        ' for document-level pointer and keyboard listeners.',
      ),
