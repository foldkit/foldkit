...
type KeyToIndexMap = Partial<Record<Key, number>>
...
function createKeyToPreviousIndex(
  ...
  const map: KeyToIndexMap = Object.create(null)
...
export function init(
  ...
  function updateChildren(
    ...
    let previousKeyToIndex: KeyToIndexMap | undefined
      ...
      if (previousStartVnode == null) {
        ...
        indexInPreviousChildren =
          nextStartKey === undefined
            ? undefined
            : previousKeyToIndex[nextStartKey]
        if (indexInPreviousChildren === undefined) {
          ...
          previousKeyToIndex[nextEndVnode.key] === undefined
        ) {
