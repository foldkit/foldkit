...
/** Creates a `Rule` that checks an array holds at least one item. */
export const nonEmpty = (
  message: RuleMessage<ReadonlyArray<unknown>> = 'Select at least one',
): Rule<ReadonlyArray<unknown>> => [Array.isReadonlyArrayNonEmpty, message]
