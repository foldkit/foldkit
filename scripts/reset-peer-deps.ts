...
const TARGETS = [
  ...
  { path: 'packages/foldkit-ui/package.json', dep: 'foldkit' },
  { path: 'packages/foldkit-devtools/package.json', dep: 'foldkit' },
  { path: 'packages/foldkit-devtools/package.json', dep: '@foldkit/ui' },
] as const
