...
// NOTE: hydration replays the embedded Flags and does not run this Effect.
// This is the fresh-render fallback, including storage-restricted contexts
// where reading document.cookie throws.
